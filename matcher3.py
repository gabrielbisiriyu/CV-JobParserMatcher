...
class CVJobMatcher:
    def __init__(self, model_name='cv_jd_finetuned_model2'):
    ...
    def cv_DOCnFIELD_level_embeddings(self, cv_text, skills, experience, max_words=350):
        ...
        skill_embeddings = self.model.encode(skills, convert_to_tensor=True)
        ...
        experience_embeddings = self.model.encode(experience_chunks, convert_to_tensor=True)
    ...
    def job_DOCnFIELD_level_embeddings(self, job_text, required_skills, responsibilities, max_words=300):
        ...
        required_skill_embeddings = self.model.encode(required_skills, convert_to_tensor=True)
        ...
        role_embeddings = self.model.encode(role_chunks, convert_to_tensor=True)
